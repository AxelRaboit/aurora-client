...
class BnbFixtures extends Fixture implements DependentFixtureInterface, FixtureGroupInterface
{
    ...
    private const array FIELDS = [
        ...
        ['name' => 'type_lit', 'label' => 'Type de lit', 'type' => 'select', 'required' => false, 'translatable' => false,
            'options' => ['choices' => ['Lit double', 'Lits jumeaux', 'Lit king size', 'Chambre familiale']],
        ],
    ...
    private const array ROOMS = [
        [
            ...
            'fields' => ['prix_nuit' => '95', 'capacite' => '2', 'superficie' => '18', 'type_lit' => 'Lit double', 'disponible' => true],
        ...
        [
            ...
            'fields' => ['prix_nuit' => '165', 'capacite' => '4', 'superficie' => '38', 'type_lit' => 'Lit king size', 'disponible' => true],
        ...
        [
            ...
            'fields' => ['prix_nuit' => '85', 'capacite' => '2', 'superficie' => '15', 'type_lit' => 'Lits jumeaux', 'disponible' => true],
        ...
        [
            ...
            'fields' => ['prix_nuit' => '140', 'capacite' => '5', 'superficie' => '32', 'type_lit' => 'Chambre familiale', 'disponible' => true],
        ...
        [
            ...
            'fields' => ['prix_nuit' => '75', 'capacite' => '2', 'superficie' => '14', 'type_lit' => 'Lit double', 'disponible' => true],
        ...
        [
            ...
            'fields' => ['prix_nuit' => '150', 'capacite' => '3', 'superficie' => '30', 'type_lit' => 'Lit king size', 'disponible' => false],
    ...
    {
        $url = $this->documentUrls->publicUrl(
